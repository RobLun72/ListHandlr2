...
test("Move item up in Handla list", async () => {
  ...
  assertElementsValueForListIndex(rows2[1].childNodes, 1, "Tesil");
  assertElementsValueForListIndex(rows2[2].childNodes, 1, "Ris");
  assertElementsValueForListIndex(rows2[3].childNodes, 1, "Tomat");
});
